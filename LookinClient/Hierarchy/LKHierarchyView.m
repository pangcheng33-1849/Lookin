...
- (void)_handleBindRequirementItem:(NSMenuItem *)menuItem {
    LKHierarchyRowView *view = [menuItem.menu lookin_getBindObjectForKey:kMenuBindKey_RowView];
    [self _updateRequirementBindingForItem:view.displayItem menuItem:menuItem bind:YES];
}

- (void)_handleUnbindRequirementItem:(NSMenuItem *)menuItem {
    LKHierarchyRowView *view = [menuItem.menu lookin_getBindObjectForKey:kMenuBindKey_RowView];
    [self _updateRequirementBindingForItem:view.displayItem menuItem:menuItem bind:NO];
}
...
- (void)_appendRequirementBindingMenuToMenu:(NSMenu *)menu displayItem:(LookinDisplayItem *)displayItem {
    ...
    [submenu lookin_bindObjectWeakly:[menu lookin_getBindObjectForKey:kMenuBindKey_RowView] forKey:kMenuBindKey_RowView];
